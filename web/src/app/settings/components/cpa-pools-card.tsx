      ...
      <CardContent className="space-y-6 p-6">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-stone-500">Configure connections first, then query remote accounts and selectively import to local pool.</p>
            </div>
          </div>
        ...
        {isLoadingPools ? (
          ...
          <div className="flex flex-col items-center justify-center gap-3 rounded-xl bg-stone-50 px-6 py-10 text-center">
            ...
            <div className="space-y-1">
              <p className="text-sm font-medium text-stone-600">No CPA connections</p>
        ...
        <div className="rounded-xl bg-stone-50 px-4 py-3 text-sm leading-6 text-stone-500">
          ...
          <ul className="mt-1 list-inside list-disc space-y-0.5">
            <li>On page load, existing CPA connections are fetched from the system.</li>
            <li>Clicking "Sync" on a connection fetches the remote account list for frontend selection.</li>
            <li>After confirming selection, the backend downloads corresponding access_tokens and imports to local pool.</li>
            <li>The frontend only polls import progress without directly participating in downloads.</li>
          </ul>
        </div>
      </CardContent>
    </Card>
